...
WIDTH, HEIGHT = 1100, 600  # ゲームウィンドウの幅，高さ
...
class Beam(pg.sprite.Sprite):
    ...
    def __init__(self, bird: Bird,angle0=0):
        ...
        angle = math.degrees(math.atan2(-self.vy, self.vx))+angle0  #角度を追加
...
class Gravity(pg.sprite.Sprite):
    ...
    def __init__(self, life):
        ...
        pg.draw.rect(self.image,(0, 0, 0),(0, 0, WIDTH, HEIGHT)) #　Surfaceにrectをdrawする
        self.image.set_alpha(128)  # 透明度を設定（0-255）
        self.rect = self.image.get_rect()
...
def main():
    ...
    while True:
        ...
        for event in pg.event.get():
            ...
            if event.type ==pg.KEYDOWN and event.key ==pg.K_SPACE and key_lst[pg.K_LSHIFT]:    #左シフトとスペースを押すと
